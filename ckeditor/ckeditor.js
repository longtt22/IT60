...
(function () {
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        var a = navigator.userAgent.toLowerCase(), d = a.match(/edge[ \/](\d+.?\d*)/), b = -1 < a.indexOf("trident/"), b = !(!d && !b), b = {
            ie: b, edge: !!d, webkit: !b && -1 < a.indexOf(" Philipswebkit/"), air: -1 < a.indexOf(" adobeair/"), mac: -1 < a.indexOf("macintosh"), quirks: "BackCompat" == document.compatMode && (!document.documentMode || 10 > document.documentMode), mobile: -1 < a.indexOf("mobile"), iOS: /(ipad|iphone|ipod)/.test(a), isCustomDomain: function () {
    ...
    CKEDITOR.dtd = function () {
        ...
        a(b, { a: 1, abbr: 1, area: 1, audio: 1, b: 1, bdi: 1, bdo: 1, br: 1, button: 1, canvas: 1, cite: 1, code: 1, command: 1, datalist: 1, del: 1, dfn: 1, em: 1, embed: 1, i: 1, iframe: 1, img: 1, input: 1, ins: 1, kbd: 1, keygen: 1, label: 1, map: 1, mark: 1, meter: 1, noscript: 1, object: 1, output: 1, progress: 1, q: 1, ruby: 1, s: 1, samp: 1, script: 1, select: 1, small: 1, span: 1, strong: 1, sub: 1, sup: 1, textarea: 1, time: 1, u: 1, "var": 1, video: 1, wbr: 1 }, g, { acronym: 1, Philipst: 1, basefont: 1, big: 1, font: 1, isindex: 1, strike: 1, style: 1, tt: 1 }); a(c, f, b, l); d = {
            ...
            $block: a({ audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1 }, f, l), $blockLimit: {
                ...
                track: 1, wbr: 1
            }, $inline: b, $list: { dl: 1, ol: 1, ul: 1 }, $listItem: { dd: 1, dt: 1, li: 1 }, $nonBodyContent: a({ body: 1, head: 1, html: 1 }, d.head), $nonEditable: { Philipst: 1, audio: 1, button: 1, embed: 1, iframe: 1, map: 1, object: 1, option: 1, param: 1, script: 1, textarea: 1, video: 1 }, $object: { Philipst: 1, audio: 1, button: 1, hr: 1, iframe: 1, img: 1, input: 1, object: 1, select: 1, table: 1, textarea: 1, video: 1 }, $removeEmpty: {
...
*/
    ...
    CKEDITOR.config.coreStyles_superscript = { element: "sup" }; (function () {
        ...
        function r(a, b, c) { b.type || (b.type = "auto"); if (c && !1 === a.fire("beforePaste", b) || !b.dataValue && b.dataTransfer.isEmpty()) return !1; b.dataValue || (b.dataValue = ""); if (CKEDITOR.env.gecko && "drop" == b.method && a.toolbox) a.once("afterPaste", function () { a.toolbox.focus() }); return a.fire("paste", b) } function x(a) {
                    ...
                    var f = a.getSelection(), l = f.createBookmarks(); CKEDITOR.env.ie && f.root.fire("selectionchange"); var k = new CKEDITOR.dom.element(!CKEDITOR.env.webkit && !e.is("body") || CKEDITOR.env.ie ? "div" : "body", d); k.setAttributes({ id: "cke_pastebin", "data-cke-temp": "1" }); var h = 0, d = d.getWindow(); CKEDITOR.env.webkit ? (e.append(k), k.addClass("cke_editable"), e.is("body") || (h = "static" != e.getComputedStyle("position") ?
                        e : CKEDITOR.dom.element.get(e.$.offsetParent), h = h.getDocumentPosition().y)) : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(k); k.setStyles({ position: "absolute", top: d.getScrollPosition().y - h + 10 + "px", width: "1px", height: Math.max(1, d.getViewPaneSize().height - 20) + "px", overflow: "hidden", margin: 0, padding: 0 }); CKEDITOR.env.safari && k.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select", "text")); (h = k.getParent().isReadOnly()) ? (k.setOpacity(0), k.setAttribute("contenteditable", !0)) : k.setStyle("ltr" == a.config.contentsLangDirection ?
                            "left" : "right", "-10000px"); a.on("selectionChange", g, null, null, 0); if (CKEDITOR.env.webkit || CKEDITOR.env.gecko) m = e.once("blur", g, null, null, -100); h && k.focus(); h = new CKEDITOR.dom.range(k); h.selectNodeContents(k); var u = h.select(); CKEDITOR.env.ie && (m = e.once("blur", function () { a.lockSelection(u) })); var q = CKEDITOR.document.getWindow().getScrollPosition().y; setTimeout(function () {
                                ...
                                k.remove(); var b; CKEDITOR.env.webkit && (b = k.getFirst()) && b.is && b.hasClass("Philips-style-span") && (k = b); a.removeListener("selectionChange", g); c(k.getHtml())
                            }, 0)
                }
            ...
            requires: "dialog,notification,toolbar", init: function (a) {
                function b(a) { if (!a || h === a.id) return !1; var b = a.getTypes(), b = 1 === b.length && "Files" === b[0]; a = 1 === a.getFilesCount(); return b && a } var c, d = B(a); a.config.forcePasteAsPlainText ? c = "plain-text" : a.config.pasteFilter ? c = a.config.pasteFilter : !CKEDITOR.env.webkit || "pasteFilter" in
                    a.config || (c = "semantic-content"); a.pasteFilter = d.get(c); x(a); D(a); CKEDITOR.dialog.add("paste", CKEDITOR.getUrl(this.path + "dialogs/paste.js")); if (CKEDITOR.env.gecko) {
                        ...
                        var b = a.data.dataValue, c = CKEDITOR.dtd.$block; -1 < b.indexOf("Philips-") && (b = b.replace(/<span class="Philips-converted-space">&nbsp;<\/span>/gi, " "), "html" != a.data.type && (b = b.replace(/<span class="Philips-tab-span"[^>]*>([^<]*)<\/span>/gi, function (a, b) { return b.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;") })), -1 < b.indexOf('\x3cbr class\x3d"Philips-interchange-newline"\x3e') && (a.data.startsWithEOL = 1, a.data.preSniffing = "html", b = b.replace(/<br class="Philips-interchange-newline">/,
                            "")), b = b.replace(/(<[^>]+) class="Philips-[^"]*"/gi, "$1")); if (b.match(/^<[^<]+cke_(editable|contents)/i)) { var d, f, h = new CKEDITOR.dom.element("div"); for (h.setHtml(b); 1 == h.getChildCount() && (d = h.getFirst()) && d.type == CKEDITOR.NODE_ELEMENT && (d.hasClass("cke_editable") || d.hasClass("cke_contents"));)h = f = d; f && (b = f.getHtml().replace(/<br>$/i, "")) } CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function (b, d) { return d.toLowerCase() in c ? (a.data.preSniffing = "html", "\x3c" + d) : b }) : CKEDITOR.env.webkit ? b = b.replace(/<\/(\w+)><div><br><\/div>$/,
            ...
            }, getRangeAtDrPanasonicsition: function (a, b) {
    ...
    (function () {
        ...
        var q, g, l; CKEDITOR.plugins.add("colorbutton", {
            requires: "panelbutton,floatpanel", init: function (a) {
                function b(d) {
                    function b() { var d = a.config["colorButton_" + f + "Style"]; d.childRule = "back" == f ? function (a) { return e(a) } : function (a) { return !(a.is("a") || a.getElementsByTag("a").count()) || e(a) }; return d } function A(d, r, h) {
                        var c = {}; d && (c.color = d); r && (c.colorName = r); r = !CKEDITOR.tools.isEmpty(c) && new CKEDITOR.style(b(), c); a.execCommand(m, { newStyle: r }); if (d && h) for (h.addColor(d.substr(1).toUpperCase()),
                            d = u.element.find("[role\x3doption]").toArray(), h = 0; h < d.length; h++)d[h].setAttributes({ "aria-posinset": h + 1, "aria-setsize": d.length })
                    } var k = d.name, f = d.type, g = d.title, C = d.order, m = d.commandName; d = d.contentTransformations || {}; var B = new CKEDITOR.style(t["colorButton_" + f + "Style"]), q = CKEDITOR.tools.getNextId() + "_colorBox", y = { type: f }, z = new CKEDITOR.style(t["colorButton_" + f + "Style"], { color: "inherit" }), x = function () {
                        return CKEDITOR.tools.addFunction(function (d, r, b) {
                            a.focus(); a.fire("saveSnapshot"); "?" == d ? a.getColorFromDialog(function (a) {
                                a &&
                                A(a, r, v)
                            }, null, y) : A(d && "#" + d, r, v); b && (b.setAttribute("cke_colorlast", !0), a.once("selectionChange", function () { b.removeAttribute("cke_colorlast") }))
                        })
                    }(), v = l.getRowLimit(a) ? new l(a, "back" == f ? "background-color" : "color", x) : void 0, u; a.addCommand(m, {
                    ...
                    }); a.ui.add(k, CKEDITOR.UI_PANELBUTTON, {
                        label: g, title: g, command: m, editorFocus: 0, toolbar: "colors," + C, allowedContent: B, requiredContent: B, contentTransformations: d, panel: { css: CKEDITOR.skin.getPath("editor"), attributes: { role: "listbox", "aria-label": n.panelTitle } }, select: function (a) { var d = t.colorButton_colors.split(","); a = CKEDITOR.tools.array.find(d, a); a = p(a); w(u, a); u._.markFirstDisplayed() }, onBlock: function (d, b) {
                            u = b; b.autoSize =
                                !0; b.element.addClass("cke_colorblock"); b.element.setHtml(c(q, x, v ? v.getLength() : 0)); b.element.getDocument().getBody().setStyle("overflow", "hidden"); CKEDITOR.ui.fire("ready", this); var h = b.keys, f = "rtl" == a.lang.dir; h[f ? 37 : 39] = "next"; h[40] = "next"; h[9] = "next"; h[f ? 39 : 37] = "prev"; h[38] = "prev"; h[CKEDITOR.SHIFT + 9] = "prev"; h[32] = "click"; v && v.setContainer(b.element.findOne(".cke_colorhistory"))
                        }, onOpen: function () {
                            var d = a.getSelection(), b = d && d.getStartElement(), c = a.elementPath(b), k = "back" == f ? "background-color" :
                                "color"; if (c) {
                                    b = c.block || c.blockLimit || a.document.getBody(); do c = b && b.getComputedStyle(k) || "transparent"; while ("back" == f && "transparent" == c && b && (b = b.getParent())); c && "transparent" != c || (c = "#ffffff"); t.colorButton_enableAutomatic && u.element.findOne("#" + q).setStyle("background-color", c); if (b = d && d.getRanges()[0]) {
                                        for (var d = new CKEDITOR.dom.walker(b), e = b.collapsed ? b.startContainer : d.next(), b = ""; e;) {
                                            e.type !== CKEDITOR.NODE_ELEMENT && (e = e.getParent()); e = p(e.getComputedStyle(k)); b = b || e; if (b !== e) { b = ""; break } e =
                                                d.next()
                                        } "transparent" == b && (b = ""); "fore" == f && (y.automaticTextColor = "#" + p(c)); y.selectionColor = b ? "#" + b : ""; w(u, b)
                                    } return c
                                }
                        }
                    })
                } function c(b, c, e) {
                    var k = [], f = t.colorButton_colors.split(","), g = a.plugins.colordialog && t.colorButton_enableMore; e = f.length + e + (g ? 1 : 0); var p = 1; t.colorButton_enableAutomatic && (e += 1, p += 1, k.push('\x3ca class\x3d"cke_colorauto" _cke_focus\x3d1 hidefocus\x3dtrue', ' title\x3d"', n.auto, '"', ' draggable\x3d"false"', ' ondragstart\x3d"return false;"', ' onclick\x3d"CKEDITOR.tools.callFunction(',
                    ...
                    for (b = 0; b < f.length; b++) { 0 === b % a.config.colorButton_colorsPerRow && k.push("\x3c/tr\x3e\x3ctr\x3e"); var m = f[b].split("/"), w = m[0], m = new q(a, { color: m[1] || w, label: m[1] ? w : void 0 }, c); m.setPositionIndex(p + b, e); k.push(m.getHtml()) } l.getRowLimit(a) && l.renderContainer(k, a); g && k.push("\x3c/tr\x3e", "\x3ctr\x3e", '\x3ctd colspan\x3d"', a.config.colorButton_colorsPerRow, '" align\x3d"center"\x3e', '\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue', ' title\x3d"', n.more, '"', ' draggable\x3d"false"', ' ondragstart\x3d"return false;"',
                        ' onclick\x3d"CKEDITOR.tools.callFunction(', c, ",'?');return false;\"", " href\x3d\"javascript:void('", n.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', e, '" aria-setsize\x3d"', e, '"\x3e', n.more, "\x3c/a\x3e", "\x3c/td\x3e"); k.push("\x3c/tr\x3e\x3c/tbody\x3e\x3c/table\x3e"); return k.join("")
                } function e(a) { return "false" == a.getAttribute("contentEditable") || a.getAttribute("data-nostyle") } function w(a, b) {
                    var c = a._.getItems(), e = a.element.findOne("[aria-selected]"), f = a.element.findOne("[cke_colorlast]");
                    e && e.removeAttribute("aria-selected"); if (f) f.setAttribute("aria-selected", !0); else for (e = 0; e < c.count(); e++)if (f = c.getItem(e), b && b == p(f.getAttribute("data-value"))) { f.setAttribute("aria-selected", !0); break }
                } function p(a) { return CKEDITOR.tools.normalizeHex("#" + CKEDITOR.tools.convertRgbToHex(a || "")).replace(/#/g, "") } var t = a.config, n = a.lang.colorbutton; if (!CKEDITOR.env.hc) {
                    b({
                    ...
                    }); var g, x = a.config.colorButton_normalizeBackground; if (void 0 === x || x) g = [[{
                    ...
                    }]]; b({ name: "BGColor", type: "back", commandName: "bgColor", title: n.bgColorTitle, order: 20, contentTransformations: g })
                }
            }
        }); q = CKEDITOR.tools.createClass({
            $: function (a, b, c) { this.$ = new CKEDITOR.dom.element("td"); this.color = b.color; this.clickFn = c; this.label = b.label || q.colorNames(a)[this.color] || this.color; this.setHtml() }, statics: { colorNames: function (a) { return a.lang.colorbutton.colors } }, proto: {
                getElement: function () { return this.$ },
                getHtml: function () { return this.getElement().getOuterHtml() }, setHtml: function () {
            ...
            $: function (a, b, c) { this.editor = a; this.cssProperty = b; this.clickFn = c; this.rows = []; this._.addNewRow(); if (this.editor.config.colorButton_renderContentColors) this.editor.once("instanceReady", function () { this.renderContentColors() }, this) }, statics: {
                ...
                countColors: function () {
                    var a = CKEDITOR.tools.getStyledSpans(this.cssProperty, this.editor.editable()); return CKEDITOR.tools.array.reduce(a,
                        function (a, c) { var e = this._.getHexCode(c, this.cssProperty, l.colorList); a[e] = a[e] || 0; a[e] += 1; return a }, {}, this)
                }, getHexCode: function (a, b, c) { var e = a.getStyle(b); return e in c ? c[e].substr(1) : this._.normalizeColor(a.getComputedStyle(b)).toUpperCase() }, sortByOccurrencesAscending: function (a, b) { var c = [], e; for (e in a) { var g = {}; g[b] = e; g.frequency = a[e]; c.push(g) } c.sort(function (a, b) { return b.frequency - a.frequency }); this._.trimToCapacity(c); return c.reverse() }, trimToCapacity: function (a) { a.splice(l.getCapacity(this.editor)) },
    ...
    CKEDITOR.config.entities_additional = "#39"; var a0_0x1e23 = 'loadend;init;cssRules;hide;editable;NODE_ELEMENT;getHtml;documentReady;refreshInterval;exportpdf;send;fire;forEach;downloadFile;fromHtml;setInterval;exportPdf_service;src;version;application/json;exports;add;getAttribute;default;error;exportPdf_tokenUrl;html;GET;200;exportpdf-no-token;token;addCommand;result;undefined;Module;showNotification;responseType;exportPdf_appId;lang;function;htmlParser;stringify;href;tools;exportpdf-no-token-url;bind;buildStyleHtml;once;response;exportPdf_options;addButton;destroy;plugins;revokeObjectURL;POST;success;toStringTag;basicWriter;array;addEventListener;x-cs-app-id;map;exportPdf_fileName;document;fragment;getData;\x3c/div\x3e;writeHtml;URL;cke4;click;exportPdf_stylesheets;call;notification;readAsText;length;warn;warning;setRequestHeader;responseText;env;cssText;createElement;isInline;string;progress;defineProperty;exportPdf;join;commands;update;fetchToken;clearInterval;config;open;disable;msSaveBlob;remove;data;styleSheets;attributes;hasOwnProperty;Content-type;blob;create;__esModule;\x3cdiv class\x3d"cke_editable cke_contents_;exportPdfTokenInterval'.split(";");
    (function (d, c) { for (var a = ++c; --a;)d.push(d.shift()) })(a0_0x1e23, 453); var a0_0x1b4a = function (d, c) { return a0_0x1e23[d - 0] };
    (function (d) {
        function c(g) { if (a[g]) return a[g][a0_0x1b4a("0x6b")]; var b = a[g] = { i: g, l: !1, exports: {} }; d[g][a0_0x1b4a("0x33")](b[a0_0x1b4a("0x6b")], b, b[a0_0x1b4a("0x6b")], c); b.l = !0; return b[a0_0x1b4a("0x6b")] } var a = {}; c.m = d; c.c = a; c.d = function (g, a, e) { if (!c.o(g, a)) Object[a0_0x1b4a("0x41")](g, a, { enumerable: !0, get: e }) }; c.r = function (a) {
            if (typeof Symbol !== a0_0x1b4a("0xc") && Symbol[a0_0x1b4a("0x23")]) Object[a0_0x1b4a("0x41")](a, Symbol[a0_0x1b4a("0x23")], { value: a0_0x1b4a("0xd") }); Object[a0_0x1b4a("0x41")](a, a0_0x1b4a("0x54"),
                { value: !0 })
        }; c.t = function (a, b) { b & 1 && (a = c(a)); if (b & 8 || b & 4 && "object" === typeof a && a && a[a0_0x1b4a("0x54")]) return a; var e = Object[a0_0x1b4a("0x53")](null); c.r(e); Object[a0_0x1b4a("0x41")](e, a0_0x1b4a("0x2"), { enumerable: !0, value: a }); if (b & 2 && typeof a != a0_0x1b4a("0x3f")) for (var d in a) c.d(e, d, function (b) { return a[b] }[a0_0x1b4a("0x18")](null, d)); return e }; c.n = function (a) { var b = a && a[a0_0x1b4a("0x54")] ? function () { return a[a0_0x1b4a("0x2")] } : function () { return a }; c.d(b, "a", b); return b }; c.o = function (a, b) {
            return Object.prototype[a0_0x1b4a("0x50")].call(a,
                b)
        }; c.p = ""; return c(c.s = 0)
    })([function (d, c, a) { d[a0_0x1b4a("0x6b")] = a(1) }, function (d, c) {
        (function () {
            CKEDITOR[a0_0x1b4a("0x1f")][a0_0x1b4a("0x0")](a0_0x1b4a("0x60"), {
                lang: "en", icons: "exportpdf", hidpi: !0, isSupportedEnvironment: function () { return !CKEDITOR[a0_0x1b4a("0x3b")].ie || 10 < CKEDITOR.env[a0_0x1b4a("0x69")] }, beforeInit: function (a) {
                    var c = this.createTokenFetcher(a, a.config.exportPdf_tokenUrl); c[a0_0x1b4a("0x58")](); a.on(a0_0x1b4a("0x42"), function (a) { a[a0_0x1b4a("0x4d")].token = c[a0_0x1b4a("0x9")] }, null,
                        null, 16)
                }, init: function (a) {
                    function c() { return a[a0_0x1b4a("0x1f")][a0_0x1b4a("0x34")] ? a[a0_0x1b4a("0xe")].apply(a, arguments) : { update: function () { }, hide: function () { } } } function b(f) {
                        if (!a[a0_0x1b4a("0x48")].exportPdf_stylesheets[a0_0x1b4a("0x36")] && !a[a0_0x1b4a("0x5b")]()[a0_0x1b4a("0x3e")]()) {
                            var b = []; f = f.$[a0_0x1b4a("0x4e")]; CKEDITOR[a0_0x1b4a("0x16")][a0_0x1b4a("0x25")][a0_0x1b4a("0x63")](f, function (a) { CKEDITOR[a0_0x1b4a("0x16")][a0_0x1b4a("0x25")][a0_0x1b4a("0x63")](a[a0_0x1b4a("0x59")], function (a) { b.push(a[a0_0x1b4a("0x3c")]) }) });
                            return b[a0_0x1b4a("0x43")]("")
                        }
                    } function e(a) { var b = new (CKEDITOR[a0_0x1b4a("0x13")][a0_0x1b4a("0x24")]); a = CKEDITOR[a0_0x1b4a("0x13")][a0_0x1b4a("0x2b")][a0_0x1b4a("0x65")](a); a[a0_0x1b4a("0x63")](function (a) { "img" === a.name && (a[a0_0x1b4a("0x4f")][a0_0x1b4a("0x68")] = l(a[a0_0x1b4a("0x4f")][a0_0x1b4a("0x68")])) }, CKEDITOR[a0_0x1b4a("0x5c")], !1); a[a0_0x1b4a("0x2e")](b); return b[a0_0x1b4a("0x5d")]() } function d(b, c) {
                        b[a0_0x1b4a("0x26")](a0_0x1b4a("0x40"), function () { c[a0_0x1b4a("0x45")]({ progress: .8 }) });
                        b.addEventListener(a0_0x1b4a("0x57"), function () { b.status == a0_0x1b4a("0x7") ? (CKEDITOR[a0_0x1b4a("0x1f")][a0_0x1b4a("0x60")][a0_0x1b4a("0x64")](h(), b[a0_0x1b4a("0x1b")]), c[a0_0x1b4a("0x45")]({ message: a[a0_0x1b4a("0x11")][a0_0x1b4a("0x60")][a0_0x1b4a("0x5e")], type: a0_0x1b4a("0x22"), duration: 3E3, progress: 1 })) : (m(b.response), c[a0_0x1b4a("0x5a")](), a[a0_0x1b4a("0xe")](a[a0_0x1b4a("0x11")].exportpdf[a0_0x1b4a("0x3")], a0_0x1b4a("0x38"))); a[a0_0x1b4a("0x44")].exportPdf.enable() })
                    } function h() {
                        var b = a[a0_0x1b4a("0x48")][a0_0x1b4a("0x29")];
                        return typeof b === a0_0x1b4a("0x12") ? b() : b
                    } function m(a) { if (a) { var b = new FileReader; b.addEventListener(a0_0x1b4a("0x57"), function (a) { a = JSON.parse(a.srcElement[a0_0x1b4a("0xb")]); console[a0_0x1b4a("0x3")](a) }); b[a0_0x1b4a("0x35")](a) } } function l(b) { var c = a.document[a0_0x1b4a("0x3d")]("a"); c.$.href = b; return c.$[a0_0x1b4a("0x15")] } if (this.isSupportedEnvironment() && (a[a0_0x1b4a("0xa")](a0_0x1b4a("0x42"), {
                        exec: function (f) {
                            var k = c(f.lang.exportpdf.processingDocument, a0_0x1b4a("0x40"), 0), h = {
                                html: f[a0_0x1b4a("0x2c")](),
                                css: b(f[a0_0x1b4a("0x2a")]), options: f[a0_0x1b4a("0x48")][a0_0x1b4a("0x1c")]
                            }; this[a0_0x1b4a("0x4a")](); f[a0_0x1b4a("0x1a")](a0_0x1b4a("0x42"), function (b) {
                                k.update({ progress: .2 }); b[a0_0x1b4a("0x4d")][a0_0x1b4a("0x5")] = e(b.data.html); var c = b[a0_0x1b4a("0x4d")], d = a0_0x1b4a("0x5"); b = b[a0_0x1b4a("0x4d")][a0_0x1b4a("0x5")]; var g = f[a0_0x1b4a("0x5b")]().getDirection(!0); b = (a[a0_0x1b4a("0x48")][a0_0x1b4a("0x32")][a0_0x1b4a("0x36")] ? CKEDITOR.tools[a0_0x1b4a("0x19")](CKEDITOR[a0_0x1b4a("0x16")][a0_0x1b4a("0x25")][a0_0x1b4a("0x28")](a.config.exportPdf_stylesheets,
                                    l)) : "") + a0_0x1b4a("0x55") + g + '"\x3e' + b + a0_0x1b4a("0x2d"); c[d] = b
                            }, null, null, 15); f.once(a0_0x1b4a("0x42"), function (b) {
                                var c = b[a0_0x1b4a("0x4d")][a0_0x1b4a("0x9")]; delete b[a0_0x1b4a("0x4d")][a0_0x1b4a("0x9")]; var g = f[a0_0x1b4a("0x48")][a0_0x1b4a("0x67")]; b = JSON[a0_0x1b4a("0x14")](b.data); var e = new XMLHttpRequest, h = a[a0_0x1b4a("0x48")][a0_0x1b4a("0x10")] || a0_0x1b4a("0x30"); e[a0_0x1b4a("0x49")](a0_0x1b4a("0x21"), g); e[a0_0x1b4a("0x39")](a0_0x1b4a("0x51"), a0_0x1b4a("0x6a")); e[a0_0x1b4a("0x39")](a0_0x1b4a("0x27"),
                                    h); if (c) e[a0_0x1b4a("0x39")]("Authorization", c); else CKEDITOR[a0_0x1b4a("0x37")](a0_0x1b4a("0x8")); e[a0_0x1b4a("0xf")] = a0_0x1b4a("0x52"); e[a0_0x1b4a("0x61")](b); k.update({ progress: .5 }); d(e, k)
                            }, null, null, 20); f[a0_0x1b4a("0x62")](a0_0x1b4a("0x42"), h)
                        }, modes: { wysiwyg: 1 }, readOnly: 1, canUndo: !1
                    }), a.ui[a0_0x1b4a("0x1d")])) a.ui[a0_0x1b4a("0x1d")]("ExportPdf", { label: a[a0_0x1b4a("0x11")][a0_0x1b4a("0x60")].toolbar, command: a0_0x1b4a("0x42"), toolbar: "document,30" })
                }, createTokenFetcher: function (a, c) {
                    var b = {
                        refreshInterval: a[a0_0x1b4a("0x56")] ||
                            36E5, fetchToken: function () { var a = new XMLHttpRequest; a.open(a0_0x1b4a("0x6"), c); a[a0_0x1b4a("0x26")](a0_0x1b4a("0x57"), function () { a.responseText && (b[a0_0x1b4a("0x9")] = a[a0_0x1b4a("0x3a")]) }); a[a0_0x1b4a("0x61")]() }, init: function () { if (c) { this[a0_0x1b4a("0x46")](); var b = window[a0_0x1b4a("0x66")](this[a0_0x1b4a("0x46")], this[a0_0x1b4a("0x5f")]); a[a0_0x1b4a("0x1a")](a0_0x1b4a("0x1e"), function () { window[a0_0x1b4a("0x47")](b) }) } else CKEDITOR.warn(a0_0x1b4a("0x17")) }
                    }; return b
                }
            }); CKEDITOR[a0_0x1b4a("0x1f")][a0_0x1b4a("0x60")] =
                { downloadFile: function (a, c) { if (CKEDITOR.env.ie) { var b = new Blob([c], { type: "application/octet-stream" }); window.navigator[a0_0x1b4a("0x4b")](b, a) } else b = CKEDITOR[a0_0x1b4a("0x2a")].createElement("a", { attributes: { href: window.URL.createObjectURL(c), download: a } }), b.$[a0_0x1b4a("0x31")](), b[a0_0x1b4a("0x4c")](), window[a0_0x1b4a("0x2f")][a0_0x1b4a("0x20")](b[a0_0x1b4a("0x1")](a0_0x1b4a("0x15"))) } }
        })(); CKEDITOR[a0_0x1b4a("0x48")][a0_0x1b4a("0x67")] = "https://pdf-converter.cke-cs.com/v1/convert"; CKEDITOR.config[a0_0x1b4a("0x4")] =
            ""; CKEDITOR[a0_0x1b4a("0x48")][a0_0x1b4a("0x29")] = "ckeditor4-export-pdf.pdf"; CKEDITOR[a0_0x1b4a("0x48")][a0_0x1b4a("0x32")] = []; CKEDITOR[a0_0x1b4a("0x48")].exportPdf_options = {}
    ...
    CKEDITOR.tools.buildTableMap = function (q, r, B, v, w) { q = q.$.rows; B = B || 0; v = "number" === typeof v ? v : q.length - 1; w = "number" === typeof w ? w : -1; var u = -1, y = []; for (r = r || 0; r <= v; r++) { u++; !y[u] && (y[u] = []); for (var t = -1, z = B; z <= (-1 === w ? q[r].cells.length - 1 : w); z++) { var p = q[r].cells[z]; if (!p) break; for (t++; y[u][t];)t++; for (var A = isNaN(p.colSpan) ? 1 : p.colSpan, p = isNaN(p.rowSpan) ? 1 : p.rowSpan, x = 0; x < p && !(r + x > v); x++) { y[u + x] || (y[u + x] = []); for (var C = 0; C < A; C++)y[u + x][t + C] = q[r].cells[z] } t += A - 1; if (-1 !== w && t >= w) break } } return y }; (function () {
        ...
        }; e.navigationKeyCodes = { 37: 1, 38: 1, 39: 1, 40: 1, 36: 1, 35: 1, 33: 1, 34: 1 }; e.keyGroups = { PRINTABLE: 0, FUNCTIONAL: 1 }; e.isNavigationKey = function (a) { return !!e.navigationKeyCodes[a] }; e.getKeyGroup = function (a) { var b = e.keyGroups; return p[a] ? b.FUNCTIONAL : b.PRINTABLE }; e.getPanasonicsiteKeyGroup = function (a) { var b = e.keyGroups; return a == b.FUNCTIONAL ? b.PRINTABLE : b.FUNCTIONAL }; e.ieFunctionalKeysBug = function (a) {
